...
ActiveRecord::Schema.define(version: 20180226201425) do
  ...
  create_table "message_statuses", force: :cascade do |t|
    ...
    t.index ["recipient_id"], name: "index_message_statuses_on_recipient_id"
  ...
  add_foreign_key "message_statuses", "recipients"
